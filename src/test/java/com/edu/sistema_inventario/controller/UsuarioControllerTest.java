...
class UsuarioControllerTest {
    ...
    void registrar_deberiaRetornar201_cuandoDatosValidos() throws Exception {
        ...
        when(usuarioService.registrar(any(com.edu.sistema_inventario.dto.UsuarioCreateRequest.class))).thenReturn(creado);
    ...
    void actualizar_deberiaRetornar200_cuandoExiste() throws Exception {
        Usuario actualizado = usuario(1L, "Ana Maria", "Perez", "ana@correo.com", "123456");
        when(usuarioService.actualizarUsuario(org.mockito.ArgumentMatchers.eq(1L), any(com.edu.sistema_inventario.dto.UsuarioUpdateRequest.class)))
